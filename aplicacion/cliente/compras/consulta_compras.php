...
<?php 
        ...
        $buscardor=mysqli_query($conexion, "SELECT * FROM compras WHERE usuario='$username'"); 
        while($resultado = mysqli_fetch_assoc($buscardor)){ 
        ?>
     
        <div id="mi_div" class="col-4">
            <div class=" tarjeta_compra" style="margin:15px;">
            <div class="d-flex justify-content-between align-items-center">
            <div class="card-body ">
                <h5 class="card-title" style="color: blue;">Datos de compra</h5>
                <hr style="border-top: 3px solid #333; margin: 30px 0;">

                <p class="card-text"><strong>ID de compra:</strong> <?php echo $resultado["id"]; ?></p>
                <p class="card-text"><strong>Usuario:</strong> <?php echo $resultado["usuario"]; ?></p>
                <p class="card-text"><strong>Fecha de compra:</strong> <?php echo $resultado["fecha"]; ?></p>
                <p class="card-text"><strong>Detalle de la compra:</strong> <?php echo $resultado["detalle_compra"]; ?></p>
                <p class="card-text"><strong>Total a pagar:</strong> <?php echo $resultado["totalAPagar"]; ?></p>
