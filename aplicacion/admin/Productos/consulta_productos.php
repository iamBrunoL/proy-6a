...
<head>
  ...
  <title>Consulta de datos de productos</title> 
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown" style="padding-right: 25px;">
          ...
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
            ...
            <a class="dropdown-item" href="registro_productos.php">Agregar productos</a>
          </div>
        </li>
  ...
  <div class="container-fluid d-flex flex-column">
    <div class="row flex-grow-1">
      ...
      <h2>Compras</h2>
        ...
        <ul class="nav flex-column">
          <li class="nav-item">
            <a class="nav-link" href="#" style="color:black;">Consultar productos</a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="registro_productos.php">Agregar productos</a>
          </li>
        </ul>
      </div>
      ...
      <h1 class="text-center">Consulta de Productos</h1>
        <div class="row justify-content-center">
          <div class="col-md-12">
            ...
            <div class="card-body">
              <form action="consulta_productos.php" method="post">
                <div class="form-group">
                  ...
                  <select class="form-control" name="consulta" id="consulta">
                    ...
                    <option value="nombre_producto">Por nombre de producto</option>
                    <option value="id_producto">Por ID</option>
                    <option value="id_img">Por ID de imagen</option>
                  </select>
                </div>
                <div class="form-group">
    ...
    if (isset($_POST['consulta'])) {
        ...
        switch ($consulta) {
            case 'nombre_producto':
                $sql = "SELECT * FROM productos WHERE nombre_producto LIKE '%$valor_consulta%';";
                break;
            case 'id_producto':
                $sql = "SELECT * FROM productos WHERE id_producto='$valor_consulta'";
                break;
            case 'id_img':
                $sql = "SELECT * FROM productos WHERE id_img LIKE '%$valor_consulta%'";
                break;
            default:
    ...
    if ($resultado->num_rows > 0) {
        ...
        echo "<tr><th>ID</th><th>Producto</th><th>Descripción</th><th>Precio</th><th>Stock</th><th>ID de imagen</th></tr>";
        echo "</thead>";
        echo "<tbody>";
