...
<head>
  ...
  <title>Eliminacíon  de datos de productos</title> 
    ...
    <div class="row flex-grow-1">
      ...
      <h2>Compras</h2>
        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#" style="color:black;">Eliminar productos</a>
          </li>
          <li class="nav-item">
      ...
      <h1 class="text-center">Eliminar Productos</h1>
		...
		if(isset($_POST['id'])){
			...
			if (mysqli_num_rows($result) > 0) {
				...
				<h4>Información del producto:</h3>
				Nombre del producto: $nombre_producto.<br>
				Descripcion: $descripcion.<br>
				Precio: $$precio_individual.<br>
				Stock: $stock.<br>
				ID de imagen: $id_img.<br>
				</div>";
				...
				echo "<div class='alert alert-danger' style='margin-top: 25px;'>No se encontró el producto.</div>";
			}
		}
