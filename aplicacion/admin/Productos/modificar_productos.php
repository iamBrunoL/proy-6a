...
<head>
  ...
  <title>Actualización de datos de productos</title> 
    ...
    <div class="row flex-grow-1">
      ...
      <h2>Compras</h2>
        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#" style="color:black;">Modificar productos</a>
          </li>
          <li class="nav-item">
      ...
      <h1 class="text-center">Modificar datos de Productos</h1>
...
if(isset($_POST['id'])){
  ...
  if(isset($_POST['actualizar'])){
    ...
    $sql = "UPDATE productos SET nombre_producto='$nombre_producto', descripcion='$descripcion', precio_individual='$precio_individual', stock='$stock', id_img='$id_img' WHERE id_producto='$id'";
  ...
  ?>
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" id="nombre_producto" name="nombre_producto" value="<?php echo $nombre_producto; ?>" required>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<input type="number" class="form-control"  id="stock" name="stock" value="<?php echo $stock; ?>" min="0" max="100" step="1">
			</div>
			<div class="form-group">
				<label for="id_img">ID de imagen:</label>
				<input type="number" class="form-control"  id="id_img" name="id_img" value="<?php echo $id_img; ?>" min="000" max="100" step="1">
			</div>
			
			<div class="form-group">
				<label for="precio_individual">Precio:</label>
				<input type="number" class="form-control"  id="precio_individual" name="precio_individual" value="<?php echo $precio_individual; ?>" min="000" max="9999" step="0.01">
			</div>
