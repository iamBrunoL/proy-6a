...
<head>
  ...
  <title>Consulta de solicitud de compras</title>
  ...
  <div class="container-fluid d-flex flex-column">
    <div class="row flex-grow-1">
      ...
      <h2>Compras</h2>
        <ul class="nav flex-column">
          <li class="nav-item">
            <a class="nav-link" href="#" style="color:black;">Consultar compras</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="modificar_compras.php">Modificar compras</a>
          </li>
          <li class="nav-item">
      ...
      <h1 class="text-center">Consulta de Compras</h1>
        <div class="row justify-content-center">
          <div class="col-md-12">
            ...
            <div class="card-body">
              <form action="consulta_compras.php" method="post">
                <div class="form-group">
                  ...
                  <select class="form-control" name="consulta" id="consulta">
                    ...
                    <option value="usuario">Por nombre de cliente</option>
          ...
          <div class="col-md-12" style="padding-buttom: 125px;">
            <div class="card-body">
              <?php
    ...
    if (isset($_POST['consulta'])) {
        ...
        switch ($consulta) {
            case 'productos':
                $sql = "SELECT * FROM compras WHERE detalle_compra LIKE '%$valor_consulta%';";
                break;
            case 'id':
                $sql = "SELECT * FROM compras WHERE id='$valor_consulta'";
                break;
            case 'usuario':
                $sql = "SELECT * FROM compras WHERE usuario='$valor_consulta'";
                break;
            default:
        ...
        // Si no se ha enviado una consulta, mostrar todos los productos
        $sql = "SELECT * FROM compras";
    }
    ...
    if ($resultado->num_rows > 0) {
        ...
        echo "<tr><th>ID</th><th>Usuario</th><th>Fecha de compra</th><th>Detalle de compra</th><th>Cantidad a pagar</th><th>Estatus de compra</th></tr>";
        echo "</thead>";
        echo "<tbody>";
        while ($fila = $resultado->fetch_assoc()) {
            ...
            echo "<td>".$fila['detalle_compra']."</td>";
            echo "<td>".$fila['totalAPagar']."</td>";
            echo "<td>".$fila['estatus_compra']."</td>";
            echo "</tr>";
        }
        echo "</tbody>";
        echo "</table>";
        ...
        echo "<div class='alert alert-warning' role='alert'>No se encontraron productos.</div>";
    }
