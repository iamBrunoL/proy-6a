...
if(isset($_POST['id'])){
    ...
    if (mysqli_num_rows($result) > 0) {
        while($row = mysqli_fetch_assoc($result)) {
            ...
            $estatus_compraA = $row["estatus_compra"];
        }
    } else {
        echo "<script>alert('No se encontró una solicitud de compra con dicha ID.');</script>";
    }
}
...
<head>
  ...
  <title>Actualización  de solicitud de compras</title> 
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown" style="padding-right: 25px;">
          ...
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
            <a class="dropdown-item" href="../Productos/consulta_productos.php">Consulta productos</a>
  ...
  <div class="container-fluid d-flex flex-column">
    <div class="row flex-grow-1">
      ...
      <h2>Compras</h2>
        <ul class="nav flex-column">
          <li class="nav-item">
            <a class="nav-link" href="consulta_compras.php">Consultar compras</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#" style="color:black;">Modificar compras</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="eliminar_compras.php">Eliminar compras</a>
          </li>
          <li class="nav-item">
      ...
      <h1 class="text-center">Modificar datos de Compras</h1>
	  <form action="" method="POST">
			...
			<div class="form-group">
				<label for="usuario">Usuario que realizó la compra:</label>
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" id="detalle_compra" name="detalle_compra" value="<?php echo $detalle_compra; ?>" required>
			</div>
...
<!-- 
			<div class="form-group">
				<label for="totalAPagar">Cantidad a pagar:</label>
				<input type="number" class="form-control"  id="totalAPagar" name="totalAPagar" value="<?php echo $totalAPagar; ?>">
			</div> -->
      <br>


      <div class="form-group">
				<h5 for="estatus_compra">Estatus de compra:</h5>

        <p>Actualmente: <strong><?php echo $estatus_compraA; ?></strong>.</p>
        
        <p>Seleccione para cambiar o confirmar</p>
				<select name="estatus_compra" class="form-control" required>
		...
		if(isset($_POST['actualizar'])){
			...
			$fecha = $_POST['fecha'];
			$estatus_compra = $_POST['estatus_compra'];

			$sql = "UPDATE compras SET usuario='$usuario', detalle_compra='$detalle_compra', fecha='$fecha', estatus_compra='$estatus_compra' WHERE id='$id'";
