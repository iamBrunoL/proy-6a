...
<head>
  ...
  <title>Eliminación de solicitud de compras</title> 
    ...
    <div class="row flex-grow-1">
      ...
      <h2>Compras</h2>
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link"  href="#" style="color:black;">Eliminar compras</a>
          </li>
          <li class="nav-item">
      ...
      <h1 class="text-center">Eliminar Solicitud de Compra</h1>
		...
		if(isset($_POST['id'])){
			...
			if (mysqli_num_rows($result) > 0) {
				...
				Compra realizada por: $usuario.<br>
				Fecha de compra: $fecha.<br>
				Cantidad a pagar: $$totalAPagar.<br>
				Detalle de compra: $detalle_compra.<br>
				Estatus de compra: $estatus_compra.<br>
				</div>";

				echo "<form action='' method='POST'>
				<input type='hidden' name='id' value='$id'>
				<button type='submit' name='eliminar' class='btn btn-danger'>Eliminar compra</button>
				</form>";
			} else {
				echo "<div class='alert alert-danger' style='margin-top: 25px;'>No se encontró la solicitud de compra.</div>";
			}
		}
		...
		if(isset($_POST['eliminar'])){
			...
			if(mysqli_query($conexion, $sql)){
				echo "<div class='alert alert-success' style='margin-top: 25px;'>Producto eliminado correctamente.</div>";
			} else {
				echo "<div class='alert alert-danger' style='margin-top: 25px;'>Error al eliminar el producto.</div>";
			}
		}
		?>
