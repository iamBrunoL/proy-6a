...
<head>
  ...
  <title>Eliminación de mensajes de contacto</title> 
    ...
    <div class="row flex-grow-1">
      ...
      <h2>Contacto</h2>
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#" style="color:black;">Eliminar  msj de contacto</a>
          </li>
        </ul>
        <hr>
      ...
      <h1 class="text-center">Eliminar mensajes de contacto</h1>
	  <form action="" method="POST">
			<div class="form-group">
				<label for="id">ID del mensaje a borrar:</label>
		...
		if(isset($_POST['id'])){
			...
			if (mysqli_num_rows($result) > 0) {
				...
				<strong>Información del mensaje de contacto:</strong><br>
				Nombre de usuario: $usuario.<br>
				Comentario: $mensaje.<br>
				Correo: $email.<br>
				Fecha de envío: $fecha.<br>
				</div>";

				echo "<form action='' method='POST'>
				<input type='hidden' name='id' value='$id'>
				<button type='submit' name='eliminar' class='btn btn-danger'>Eliminar mensaje de contacto</button>
				</form>";
			} else {
				echo "<div class='alert alert-danger' style='margin-top: 25px;'>No se encontró el mensaje de contacto.</div>";
			}
		}
		...
		if(isset($_POST['eliminar'])){
			...
			if(mysqli_query($conexion, $sql)){
				echo "<div class='alert alert-success' style='margin-top: 25px;'>Mensaje de contacto eliminado correctamente.</div>";
			} else {
				echo "<div class='alert alert-danger' style='margin-top: 25px;'>Error al eliminar el mensaje de contacto.</div>";
			}
		}
		?>
