  ...
  <div class="container-fluid d-flex flex-column">
    <div class="row flex-grow-1">
      ...
      <h2>Compras</h2>
        ...
        <ul class="nav flex-column">
          <li class="nav-item">
            <a class="nav-link"  href="#" style="color:black;">Consultar usuarios</a>
          </li>
          <li class="nav-item">
      ...
      <h1 class="text-center">Consulta de Usuarios</h1>
        <div class="row justify-content-center">
          <div class="col-md-12">
					...
					<div class="card-body">
						<form action="consulta_usuarios.php" method="post">
    ...
    if (isset($_POST['consulta'])) {
        ...
        switch ($consulta) {
            case 'username':
                $sql = "SELECT * FROM usuarios WHERE username LIKE '%$valor_consulta%';";
                break;
            case 'id':
                $sql = "SELECT * FROM usuarios WHERE id='$valor_consulta'";
                break;
            case 'correo':
                $sql = "SELECT * FROM usuarios WHERE correo='$valor_consulta'";
                break;
            default:
    ...
    if ($resultado->num_rows > 0) {
        ...
        echo "<tr><th>ID</th><th>Nombre</th><th>Apellido</th><th>Correo</th><th>Username</th><th>Edad</th><th>Género</th></tr>";
        echo "</thead>";
        echo "<tbody>";
